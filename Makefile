...
RM = rm -f
SRC = bmp_creater.c color.c cylinder_intersection.c main.c  multi_threading.c  ray_tracing.c sample_pixel.ctextures.c \
	camera.ccube_pyramid_intersection.c light.c mlx_things.c  plane_intersection.c  reflect_and_refract.c sphere_intersection.c \
	...
	libft/ft_strrchr.c      libft/ft_tolower.c 	libft/ft_strcat.c 
